          ...
          <div className="flex flex-col gap-12">
            <div>
              <h2 className="text-2xl font-bold text-gray-800 mb-6 pb-2 border-b border-gray-200">
                Easy-Moderate Level <span className="text-sm text-gray-400 font-normal ml-2">(1st 20 quizzes)</span>
              </h2>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {mockTests.slice(0, 20).map((test, localIdx) => renderTestCard(test, localIdx))}
              </div>
            </div>
            ...
            {mockTests.length > 20 && (
              <div>
                <h2 className="text-2xl font-bold text-gray-800 mb-6 pb-2 border-b border-gray-200">
                  Moderate-Hard Level <span className="text-sm text-gray-400 font-normal ml-2">(Next 20 quizzes)</span>
                </h2>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {mockTests.slice(20).map((test, localIdx) => renderTestCard(test, localIdx + 20))}
                </div>
              </div>
            )}
          </div>
